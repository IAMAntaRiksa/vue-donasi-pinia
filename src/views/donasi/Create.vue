        ...
        <div class="container mx-auto grid grid-cols-1 p-3 sm:w-full md:w-5/12">
            <div class="bg-white rounded-md shadow-md p-5">
                ...
                <div class="mb-2">
                    ...
                    <input type="number" v-model="donation.amount"
                ...
                <button @click="storeDonation()"
                    class="mt-4 bg-yellow-500 py-2 rounded-md shadow-md text-base w-full uppercase font-bold focus:outline-none focus:bg-yellow-600">LANJUT
                    PEMBAYARAN</button>
